...
var map = new ol.Map({
    ...
    view: new ol.View({
         maxZoom: 28, minZoom: 1, projection: new ol.proj.Projection({
            code: 'EPSG:31983',
            //extent: [598579.164301, 7456806.775936, 695060.515065, 7493967.699202],
            units: 'm'})
    })
});

//initial view - epsg:3857 coordinates if not "Match project CRS"
map.getView().fit([678797.839114, 7466249.801788, 699357.534289, 7478425.790874], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Zoneamento do PDZ do Porto do Rio de Janeiro</h2>';
        return titleElement;
    })(),
